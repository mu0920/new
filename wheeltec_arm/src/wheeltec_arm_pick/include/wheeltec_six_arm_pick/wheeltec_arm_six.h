...
class turn_on_robot
{
	...
	private:
		...
		string usart_port_name, gyro_frame_id,robot_frame_id, odom_frame_id, smoother_cmd_vel;
		ros::NodeHandle n;//创建句柄
		ros::Time _Now, _Last_Time;//时间相关
		float Sampling_Time; //采样时间
		ros::Subscriber Cmd_Vel_Sub, Amcl_Sub,joint_state_Sub,color_joint_state_Sub,arm_teleop_Sub;//初始化订阅者

...
int main(int argc, char **argv)
{
    ...
    {   
        ...
        scale_trajectory_speed(my_plan,0.5);
	    arm.execute(my_plan); //execute函数输入参数是my_plan这个结构体
        sleep(1);
    }
    else
    {
        system("aplay -D plughw:CARD=Device,DEV=0 ~/wheeltec_robot/src/xf_mic_asr_offline/feedback_voice/cartesian/cartesian_fail.wav");

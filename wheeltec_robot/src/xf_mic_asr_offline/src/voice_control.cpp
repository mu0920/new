...
int main(int argc, char *argv[])
{
	...
	ndHandle.param("source_path", source_path, std::string("/home/ubuntu/scd/src/wheeltec_robot/src/xf_mic_asr_offline"));
	ndHandle.param("/appid", appid, std::string("a6d355b3"));//appid，需要更换为自己的
